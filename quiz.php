    ...
    <form action="score.php" method="post" id="quizForm" class="quiz-form">
        ...
        <?php 
            ...
            for ($i=1; $i <= $chosenone; $i++){
                ...
                $zapytanie2 = "SELECT id as ids from collection where category='" . $categoryTable . "'";
                $wynik2 = mysqli_query($polaczenie, $zapytanie2);
                $idArray = array();

                // Pobieranie ID z tabeli
                ...
                do {
                    $random_question = $idArray[mt_rand(0,sizeof($idArray)-1)];
                }
                ...
                foreach ($answers as $ans) {
                    ...
                    $sql = "SELECT image, type FROM images where id_number = " . $random_question;
