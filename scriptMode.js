...
function changeMode(mode) {
	...
	if (mode == "light") {
		...
		document.documentElement.style.setProperty("--login-button-text-color", "rgb(250, 250, 250)");

		document.documentElement.style.setProperty("--select-text-color", "rgb(0, 0, 0)");
		document.documentElement.style.setProperty("--select-text-color-focused", "rgb(0, 0, 0)");
		...
		document.documentElement.style.setProperty("--login-button-text-color", "rgb(0, 0, 0)");

		document.documentElement.style.setProperty("--select-text-color", "rgb(225, 225, 225)");
		document.documentElement.style.setProperty("--select-text-color-focused", "rgb(0, 0, 0)");
	}
}
